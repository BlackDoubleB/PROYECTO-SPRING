...
function habilitarBtnVerCarta() {
	$("#btn-ver-carta").click(function(e) {
		procesarVerCarta(e)
	})
}
...
function procesarVerCarta(e) {
	e.preventDefault();

	var settings = {
		"url": "http://localhost:8080/api/media/carta.pdf",
		"method": "GET",
		"timeout": 0,
		"xhr":function(){
	...
	$.ajax(settings).done(function(response) {
		if (!response) {
			toastr["warning"]("No hay carta subida.", "Validación")
			return
		}
