...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	protected void successfulAuthentication(HttpServletRequest request, 
		...
		String token = jwtUtils.createToken(userDetails.getIdConsumidor(), userDetails.getUsername(), userDetails.getNombres(), userDetails.getRol());
		
		String bearer = "Bearer " + token;
		
		response.addHeader("Authorization", bearer);
		response.addHeader("Access-Control-Expose-Headers", "cache-control, pragma, expires, authorization, set-cookie");
